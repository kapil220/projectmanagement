...
import { Section as SectionType, TaskType } from './types'; // Ensure consistent import path
...
const TaskListViewSection: React.FC<ListViewSectionProps> = ({
  section,
  updateTask,
  deleteTask,
  duplicateTask,
...
export default TaskListViewSection;
